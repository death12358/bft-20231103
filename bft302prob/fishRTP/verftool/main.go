...
func main() {
	...
	for i := 1; i <= gr.Settings.ExecutionRounds; i++ {
		...
		// fmt.Println("step4InsertPlayer")
		// ym, err := yaml.Marshal(gr)
		// if err != nil {
		// 	LogTool.LogInfo("err:", err)
		// }
		// LogTool.LogInfo("log\n", string(ym))
		...
		// fmt.Println("step5GetRTPResult")
		// ym5, err := yaml.Marshal(gr)
		// if err != nil {
		// 	LogTool.LogInfo("err:", err)
		// }
		// LogTool.LogInfo("log\n", string(ym5))
		...
		res.MultipleLimit = rtpRes.MultipleLimit
		if !gr.Settings.Mode {
			gr.step6AddBetPay()
			// fmt.Println("step6AddBetPay()")
			// ym6, err := yaml.Marshal(gr)
			// if err != nil {
			// 	LogTool.LogInfo("err:", err)
			// }
			// LogTool.LogInfo("log\n", string(ym6))
			// fmt.Println("step6AddBetPay")
			// gr.step7UpdateRTPCtrl(rtpRes)
		}
